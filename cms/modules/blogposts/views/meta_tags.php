...
$tabMetaTagsContent = '<table width="100%" border="0" 
    ...
    <tr>
      ...
      <td>
        ...
        value="'.$itemTitle.'" style="width:600px;"><br>
    ...
    <tr>
      ...
      <td>
        <textarea name="meta_description" id="meta_description"
         class="check-max"
         style="width:600px;"
         rows="5" >'.$itemMetaDescription.'</textarea>
        <br>
        <span class="text-muted">
          <small>
            Meta descriptions should be between 150-160 characters (including spaces) 
            <em></em>
          </small>
        </span>
      </td>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="og_title" id="og_title" class="check-max"
         value="'.$itemOgTitle.'" style="width:600px;"><br>
        <span class="text-muted">
          <small>
    ...
    <tr>
      ...
      <td>
        <input type="text" name="og_image" id="og_image" 
         value="'.$itemOgPhotoPath.'" style="width:350px;" readonly autocomplete="off">
    ...
    <tr>
      ...
      <td>
        <textarea name="og_meta_description" id="og_meta_description" class="check-max" 
         style="width:600px;" rows="5" >'.$itemOgMetaDescription.'</textarea>
        <br>
        <span class="text-muted">
          <small>
            Meta descriptions should be between 150-160 characters (including spaces) 
