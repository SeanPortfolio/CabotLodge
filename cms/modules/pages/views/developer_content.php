    ...
    <tr>
      ...
      <td valign="top">
        <textarea name="page_code_head_close" id="page_code_head_close"
         style="width:720px; height:150px;resize:none;">'.$pageCodeHeadClose
         .'</textarea>
    ...
    <tr>
      ...
      <td valign="top">
        <textarea name="page_code_body_open"  id="page_code_body_open"
         style="width:720px; height:150px;resize:none;">'.$pageCodeBodyOpen
         .'</textarea>
        <span data-toggle="tooltip" data-placement="left"
    ...
    <tr>
      ...
      <td valign="top">
        <textarea name="page_code_body_close"  id="page_code_body_close" 
         style="width:720px; height:150px;resize:none;">'.$pageCodeBodyClose
         .'</textarea>
        <span data-toggle="tooltip" data-placement="left" 
