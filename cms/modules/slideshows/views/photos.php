...
if(!empty($arrPhotos)) {     
  ...
  foreach ($arrPhotos as $photo) {
    ...
    if($orgHeight!=0 && $orgWidth !=0) {
      ...
      $photoList .= '<li id="photo_'.$photoCount.'">
          <div class="to-left">
            <div class="img-wrap">
              <img src="'.$photoFullPath.'" alt="Slide Image '.$photoCount.'">
              <input type="hidden" name="pss_full_path[]"
               value="'.$photoFullPath.'">
            </div>
          </div>
            ...
            <ul>
              <li>
                ...
                <input type="text" maxlength="150"
                 ...
                 name="pss_photo_caption_heading[]"
                 value="'.$captionHeading.'" class="input-xxlrg">
              </li>
              <li>
                <label for="caption-'.$photoCount.'">Caption:</label>
                <input type="text" maxlength="150" id="caption-'.$photoCount.'"
                 name="pss_photo_caption[]"
              ...
              <li>
                ...
                <input type="text" id="rank-'.$photoCount.'" 
                 name="pss_photo_rank[]" value="'.$rank.'" 
                 class="input-small">
                <input type="hidden" id="ind-'.$photoCount.'"
                 name="pss_photo_ind[]"
                 value="'.$photoInd.'" class="input-small">
                <a href="javascript:;" 
                 onClick="removePhoto('.$photoCount.');">Remove
                </a>
              </li>
            </ul>
          </div>
        ...
        <div class="to-left padded">\
          <ul>\
            <li>\
              ...
              <input type="text" id="caption-heading-'+num+'" maxlength="150"\
              name="pss_photo_caption_heading[]" value="" class="input-xxlrg">\
            </li>\
            <li>\
              <label for="caption-'+num+'">Caption:</label>\
              <input type="text" id="caption-'+num+'" maxlength="150"\
              name="pss_photo_caption[]" value="" class="input-xxlrg">\
            </li>\
            <li>\
              <label for="photo-alt-'+num+'">Alt text:</label>\
              <input type="text" id="photo-alt-'+num+'" maxlength="150"\
              name="pss_photo_alt[]" value="" class="input-xxlrg">\
            </li>\
            <li>\
              <label for="rank-'+num+'" >Rank:</label>\
              <input type="text" id="rank-'+num+'"\
              name="pss_photo_rank[]" value="" class="input-small">\
              <input type="hidden" id="ind-$photoCount"\
              name="pss_photo_ind[]" value="0" class="input-small">\
