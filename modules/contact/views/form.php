  ...
  <form action="'.$contactPageFullUrl.'" method="post" role="form" class="contact__form">
    <fieldset>
      ...
      <div class="form__group form__group--half form__group--inline">
        ...
        <input type="tel" id="contact-number" class="form__control" 
         value="'.$contactNumber.'" name="contact-number" tabindex="4">
      </div>
      <div class="form__group '.$subjectErrorCls.'">
        <label for="subject" class="form__control__label">Subject<span class="text-danger">*</span></label>
        <input type="text" id="subject" class="form__control" name="subject" value="'.$subject.'" tabindex="5">
        '.$subjectErrorMsg.'
      </div>
      <div class="form__group '.$messageErrorCls.'">
        ...
        <textarea name="message" id="message" class="form__control" tabindex="6" rows="12">'.$message.'</textarea>
        '.$messageErrorMsg.'
      </div>
      ...
      <div class="form__group text-center">
        <button type="submit" class="btn btn--brown-ghost text-uppercase" name="continue" value="1" tabindex="8">
